...
class DockerContainerManagerSpec extends FunSuite {
  val linkedContainer1 = DockerContainer("nginx:1.17.10", name = Some("linkedContainer1"))
  val linkedContainer2a = DockerContainer("nginx:1.17.10", name = Some("linkedContainer2a"))
    .withLinks(ContainerLink(linkedContainer1, "linkedContainer1"))
  val linkedContainer2b = DockerContainer("nginx:1.17.10", name = Some("linkedContainer2b"))
    .withLinks(ContainerLink(linkedContainer1, "linkedContainer1"))
  val linkedContainer3 = DockerContainer("nginx:1.17.10", name = Some("linkedContainer3"))
  ...
  val unlinkedContainer1 = DockerContainer("nginx:1.17.10", name = Some("unlinkedContainer1"))
  val unlinkedContainer2a = DockerContainer("nginx:1.17.10", name = Some("unlinkedContainer2a"))
    .withUnlinkedDependencies(unlinkedContainer1)
  val unlinkedContainer2b = DockerContainer("nginx:1.17.10", name = Some("unlinkedContainer2b"))
    .withUnlinkedDependencies(unlinkedContainer1)
  val unlinkedContainer3 = DockerContainer("nginx:1.17.10", name = Some("unlinkedContainer3"))
